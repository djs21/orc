---
description: "orc orchestrator agent"
mode: primary
permission:
  edit: ask
  bash: ask
...
Start by running `orc status` to check current state. Then greet the user and ask what they'd like to work on across their projects.
